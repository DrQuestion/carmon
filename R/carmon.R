...
#'   currently available are: `"coglasso"` for \emph{collaborative graphical lasso},
...
#'   consensus? Default is 20. When given together with the `quantile_c_measures`
...
#' analysis:
#' \itemize{
#' \item `report` an R data frame. The rows correspond to the nodes identified to
...
#' }
#'
#' @references For \emph{collaborative graphical lasso} and \emph{eXtended StARS}, see
...
#'
carmon <- function(layers, ..., p = NULL, omics = NULL, marginals = NULL,
                   noninv_method = NULL, copula = NULL,
                   net_method = "coglasso", sel_method = NULL,
                   cor_cutoff = NULL, cor_quant = NULL, minimal_output = FALSE,
                   analyse = TRUE, c_measures = "dbce",
                   max_candidates_c_measures = NULL, quantile_c_measures = NULL,
...
#'
#' Print information on the selected carmon network and the explored hyperparameters
